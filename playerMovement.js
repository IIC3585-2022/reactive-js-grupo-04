...
const movePlayer = (id, movs) => {
  if (movs.includes('up') && playerPos[id].y > 0) playerPos[id].y -= 5;
  if (movs.includes('down') && playerPos[id].y < 500 ) playerPos[id].y += 5; 
  if (movs.includes('right') && playerPos[id].x < 630) playerPos[id].x += 5;
  if (movs.includes('left') && playerPos[id].x > 0) playerPos[id].x -= 5;
